Namespace LoginServer.Log
    Module GameLog
        ...
        Public Sub WriteGameLog(ByVal Index_ As Integer, ByVal Action As String, ByVal Action2 As String, ByVal Message As String)
            ...
            DataBase.InsertData(String.Format("INSERT INTO log(ip_adress, charname, action, action2, parameter, time) VALUE ('{0}','[UNKNWON]','{1}','{2}','{3}','{4}')", IP, Action, Action2, Message, time))
        End Sub
