...
#Region "Gamelog"
    Public Sub WriteGameLog(ByVal Index_ As Integer, ByVal IP As String, ByVal Action As String, ByVal Action2 As String, ByVal Message As String)
        ...
        RaiseEvent OnDatabaseQuery(String.Format("INSERT INTO log(ip_adress, charname, action, action2, parameter, time) VALUE ('{0}','[UNKNWON]','{1}','{2}','{3}','{4}')", IP, Action, Action2, Message, time))
    End Sub
#End Region
