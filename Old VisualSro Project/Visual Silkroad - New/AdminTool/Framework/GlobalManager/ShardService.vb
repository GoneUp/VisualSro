...
Namespace GlobalManager
    Module ShardService
        ...
        Public Sub OnSendMyInfo()
            ...
            writer.Word(GlobalManagerCon.ManagerSocket.LocalEndPoint.ToString.Split(":")(0).Length)
            writer.String(GlobalManagerCon.ManagerSocket.LocalEndPoint.ToString.Split(":")(0))
            writer.Word(GlobalManagerCon.ManagerSocket.LocalEndPoint.ToString.Split(":")(1))
