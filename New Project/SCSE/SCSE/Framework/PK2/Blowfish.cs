    ...
    public class Blowfish
        {
            ...
            public const int MAX_KEY_LENGTH = 0x38;
            protected uint[] pbox;
            private const int PBOX_ENTRIES = 0x12;
            protected static readonly uint[] PBOX_INIT = new uint[] { 
            ...
            private const int SBOX_ENTRIES = 0x100;
            protected static readonly uint[] SBOX_INIT_1 = new uint[] { 
            ...
            protected static readonly uint[] SBOX_INIT_2 = new uint[] { 
            ...
            protected static readonly uint[] SBOX_INIT_3 = new uint[] { 
            ...
            protected static readonly uint[] SBOX_INIT_4 = new uint[] { 
            ...
            private static readonly byte[] TEST_KEY = new byte[] { 0x1c, 0x58, 0x7f, 0x1c, 0x13, 0x92, 0x4f, 0xef };
            private static readonly uint[] TEST_VECTOR_CIPHER = new uint[] { 0x55cb3774, 0xd13ef201 };
            private static readonly uint[] TEST_VECTOR_PLAIN = new uint[] { 0x30553228, 0x6d6f295a };

            public Blowfish()
            {
                this.pbox = new uint[0x12];
                this.sbox1 = new uint[0x100];
                this.sbox2 = new uint[0x100];
                this.sbox3 = new uint[0x100];
                this.sbox4 = new uint[0x100];
                this.block = new byte[8];
                this.Initialize(null, 0, 0);
            }

            public Blowfish(byte[] key, int ofs, int len)
            {
                this.pbox = new uint[0x12];
                this.sbox1 = new uint[0x100];
                this.sbox2 = new uint[0x100];
            ...
            public int Decrypt(byte[] dataIn, int posIn, byte[] dataOut, int posOut, int count)
            {
                uint[] numArray = this.sbox1;
                uint[] numArray2 = this.sbox2;
                uint[] numArray3 = this.sbox3;
                uint[] numArray4 = this.sbox4;
                uint[] pbox = this.pbox;
                uint num = pbox[0];
                uint num2 = pbox[1];
                uint num3 = pbox[2];
                ...
                uint num15 = pbox[14];
                uint num16 = pbox[15];
                uint num17 = pbox[0x10];
                uint num18 = pbox[0x11];
                count &= -8;
                int num19 = posIn + count;
                while (posIn < num19)
                {
                    uint num20 = (uint)((((dataIn[posIn] << 0x18) | (dataIn[posIn + 1] << 0x10)) | (dataIn[posIn + 2] << 8)) | dataIn[posIn + 3]);
                    uint num21 = (uint)((((dataIn[posIn + 4] << 0x18) | (dataIn[posIn + 5] << 0x10)) | (dataIn[posIn + 6] << 8)) | dataIn[posIn + 7]);
                    posIn += 8;
                    num20 ^= num18;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num17;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num16;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num15;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num14;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num13;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num12;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num11;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num10;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num9;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num8;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num7;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num6;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num5;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num4;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num3;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num2;
                    num21 ^= num;
                    dataOut[posOut] = (byte)(num21 >> 0x18);
                    dataOut[posOut + 1] = (byte)(num21 >> 0x10);
                    dataOut[posOut + 2] = (byte)(num21 >> 8);
                    dataOut[posOut + 3] = (byte)num21;
                    dataOut[posOut + 4] = (byte)(num20 >> 0x18);
                    dataOut[posOut + 5] = (byte)(num20 >> 0x10);
                    dataOut[posOut + 6] = (byte)(num20 >> 8);
                    dataOut[posOut + 7] = (byte)num20;
                    posOut += 8;
                }
                return count;
            }

            public void DecryptBlock(uint hi, uint lo, out uint outHi, out uint outLo)
            {
                byte[] block = this.block;
                block[0] = (byte)(hi >> 0x18);
                block[1] = (byte)(hi >> 0x10);
                block[2] = (byte)(hi >> 8);
                block[3] = (byte)hi;
                block[4] = (byte)(lo >> 0x18);
                block[5] = (byte)(lo >> 0x10);
                block[6] = (byte)(lo >> 8);
                block[7] = (byte)lo;
                this.Decrypt(block, 0, block, 0, 8);
                outHi = (uint)((((block[0] << 0x18) | (block[1] << 0x10)) | (block[2] << 8)) | block[3]);
                outLo = (uint)((((block[4] << 0x18) | (block[5] << 0x10)) | (block[6] << 8)) | block[7]);
            }

            public int DecryptRev(byte[] dataIn, int posIn, byte[] dataOut, int posOut, int count)
            {
                uint[] numArray = this.sbox1;
                uint[] numArray2 = this.sbox2;
                uint[] numArray3 = this.sbox3;
                ...
                while (posIn < num19)
                {
                    uint num20 = (uint)((((dataIn[posIn + 3] << 0x18) | (dataIn[posIn + 2] << 0x10)) | (dataIn[posIn + 1] << 8)) | dataIn[posIn]);
                    uint num21 = (uint)((((dataIn[posIn + 7] << 0x18) | (dataIn[posIn + 6] << 0x10)) | (dataIn[posIn + 5] << 8)) | dataIn[posIn + 4]);
                    posIn += 8;
                    num20 ^= num18;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num17;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num16;
                    ...
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num2;
                    num21 ^= num;
                    dataOut[posOut + 3] = (byte)(num21 >> 0x18);
                    dataOut[posOut + 2] = (byte)(num21 >> 0x10);
                    dataOut[posOut + 1] = (byte)(num21 >> 8);
                    dataOut[posOut] = (byte)num21;
                    dataOut[posOut + 7] = (byte)(num20 >> 0x18);
                    dataOut[posOut + 6] = (byte)(num20 >> 0x10);
                    dataOut[posOut + 5] = (byte)(num20 >> 8);
                    dataOut[posOut + 4] = (byte)num20;
                    posOut += 8;
                }
                return count;
            }
            ...
            public int Encrypt(byte[] dataIn, int posIn, byte[] dataOut, int posOut, int count)
            {
                ...
                while (posIn < num19)
                {
                    ...
                    posIn += 8;
                    num20 ^= num;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num2;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num3;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num4;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num5;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num6;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num7;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num8;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num9;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num10;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num11;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num12;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num13;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num14;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num15;
                    num21 ^= (((numArray[num20 >> 0x18] + numArray2[((int)(num20 >> 0x10)) & 0xff]) ^ numArray3[((int)(num20 >> 8)) & 0xff]) + numArray4[((int)num20) & 0xff]) ^ num16;
                    num20 ^= (((numArray[num21 >> 0x18] + numArray2[((int)(num21 >> 0x10)) & 0xff]) ^ numArray3[((int)(num21 >> 8)) & 0xff]) + numArray4[((int)num21) & 0xff]) ^ num17;
                    num21 ^= num18;
                    dataOut[posOut] = (byte)(num21 >> 0x18);
                    dataOut[posOut + 1] = (byte)(num21 >> 0x10);
                    dataOut[posOut + 2] = (byte)(num21 >> 8);
            ...
            public void EncryptBlock(uint hi, uint lo, out uint outHi, out uint outLo)
            {
                ...
                block[6] = (byte)(lo >> 8);
                block[7] = (byte)lo;
                this.Encrypt(block, 0, block, 0, 8);
                outHi = (uint)((((block[0] << 0x18) | (block[1] << 0x10)) | (block[2] << 8)) | block[3]);
                outLo = (uint)((((block[4] << 0x18) | (block[5] << 0x10)) | (block[6] << 8)) | block[7]);
            }

            public int EncryptRev(byte[] dataIn, int posIn, byte[] dataOut, int posOut, int count)
            {
                uint[] numArray = this.sbox1;
                uint[] numArray2 = this.sbox2;
                uint[] numArray3 = this.sbox3;
            ...
            public void Initialize(byte[] key, int ofs, int len)
            {
                ...
                if (len != 0)
                {
                    ...
                    pbox = this.sbox4;
                    for (int num12 = 0; num12 < 0x100; num12 += 2)
                    {
                        this.EncryptBlock(hi, lo, out hi, out lo);
                        pbox[num12] = hi;
                        pbox[num12 + 1] = lo;
